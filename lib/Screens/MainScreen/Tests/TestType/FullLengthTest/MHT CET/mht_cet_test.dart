...
class MHTCETtestinterface extends StatefulWidget {
  @override
  _MHTCETtestinterface createState() => _MHTCETtestinterface();
}
...
class _MHTCETtestinterface extends State<MHTCETtestinterface> {
  ...
  bool isBarOpen = true; // Toggle variable for collapsible bar
    ...
    return Scaffold(
      ...
      body: Row(
        children: [
          ...
          // Right collapsible bar
          AnimatedContainer(
            duration: const Duration(milliseconds: 300),
            width: isBarOpen ? 250 : 50, // Expand or collapse width
            ...
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    setState(() {
                      isBarOpen = !isBarOpen; // Toggle the bar
                    });
                  },
                  child: Container(
                    color: Colors.blue,
                    ...
                    child: Center(
                      child: Icon(
                        isBarOpen ? Icons.arrow_forward_ios : Icons.arrow_back_ios,
                        color: Colors.white,
                      ),
                    ),
                  ),
